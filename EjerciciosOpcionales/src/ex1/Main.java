...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * sempre en comparaci� un altre element donat 
		 * 
		 * linkedlist
		 * 
		 * - Una llista en la qu�
		 * constanment accedirem als elements per posici� absoluta.
		 * 
		 * ArrayList
		 * 
		 * Exercici 3. - Ocupen m�s espai d'emmagatzematge les llistes que els
		 * vectors de la mateixa mida? - Perqu� no necessitem iteradors pel
		 * vectors?
		 * El vector no necesita iterator porque el que se agrega y se extraer el �ltimo siempre (LIFO)
		 * 
		 * 
		 */
	}
